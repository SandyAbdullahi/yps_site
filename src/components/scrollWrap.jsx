...
const VelocityScrollAnimation = () => {
    ...
    return (
        <motion.div className="relative flex flex-col p-8 parallax-text bg-vampire-black text-white overflow-hidden" 
           
        >
            <motion.h1 className="text-9xl whitespace-nowrap text-left"
             initial = {{ x: '-1500%' }}
             animate = {{
                 x: 1500,
                 transition: {
