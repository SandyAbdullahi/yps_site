...
const VelocityScrollAnimation = () => {
    ...
    return (
        <motion.div className="relative flex flex-col p-10 parallax-text bg-black text-white overflow-hidden" 
           
        >
            <motion.h1 className="text-9xl whitespace-nowrap m-10 text-left"
             initial = {{ x: '-1500%' }}
             animate = {{
                 x: 1500,
                 transition: {
